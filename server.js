...
var energyvalueroutes = require('./api/energyvalue.routes');
...
app.use('/api/v1', energyvalueroutes);
...
app.listen(config.env.webPort, function () {
    ...
    console.log('Zie bijvoorbeeld http://localhost:3000/api/v1/energyvalues voor alle energyvalues');
});
